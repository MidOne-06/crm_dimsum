...
return [
    ...
    */
    ...
    'payload' => [
        // Los reportes de Stock Actual (Consolidado/Stock) mantienen el maestro
        // operativo completo (cientos de filas) como estado del componente
        // Livewire, así que el límite por defecto de 1MB se queda corto.
        'max_size' => (int) env('LIVEWIRE_PAYLOAD_MAX_SIZE', 15 * 1024 * 1024), // 15MB
