                    ...
                    <tbody>
                        @foreach ($historial as $item)
                            <tr class="fi-ta-row">
                                ...
                                <td class="fi-ta-cell"><div class="opm-table-number px-3 py-3 text-sm text-gray-950 dark:text-white">{{ $item->locales_procesados }} / {{ $item->locales_total ?? '—' }}</div></td>
                                <td class="fi-ta-cell"><div class="opm-table-number px-3 py-3 text-sm text-gray-950 dark:text-white">{{ $item->movimientos_guardados }}</div></td>
                                <td class="fi-ta-cell"><div class="opm-table-number px-3 py-3 text-sm text-danger-600 dark:text-danger-400">{{ $item->locales_fallidos }}</div></td>
