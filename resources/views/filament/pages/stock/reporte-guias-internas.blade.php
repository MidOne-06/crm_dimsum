<x-filament-panels::page>
    <div class="space-y-6">
        <div class="flex flex-wrap justify-end gap-3">
            ...
            @if (auth()->user()?->hasPermission('guias-internas.reporte.exportar'))
        ...
        <x-filament::modal id="filtros-reporte-guias-internas" width="5xl" sticky-header sticky-footer>
            <x-slot name="heading">Filtros de reporte</x-slot>

            <form id="filtros-reporte-guias-internas-form" wire:submit="search" class="space-y-5">
