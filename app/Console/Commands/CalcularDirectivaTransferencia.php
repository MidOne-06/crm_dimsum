...
class CalcularDirectivaTransferencia extends Command
{
    ...
    protected $description = 'Calcula la cantidad sugerida a despachar por local x ítem para la fecha indicada (por defecto hoy), en base al promedio histórico del mismo día de la semana y el saldo en tiempo real.';
    ...
    public function handle(DirectivaTransferenciaService $service): int
    {
        ...
        $total = $service->calcularParaFecha($fecha);
