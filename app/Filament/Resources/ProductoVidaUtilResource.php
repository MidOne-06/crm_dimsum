...
use App\Filament\Resources\ProductoVidaUtilResource\Pages;
use App\Models\KardexMovimiento;
use App\Models\ProductoVidaUtil;
...
/** Días de vida útil por producto (Directiva de Transferencia, Fase 0): acota cuánto tiene sentido enviar aunque haya demanda y espacio de sobra. */
class ProductoVidaUtilResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->schema([
            Section::make()->schema([
                ...
                TextInput::make('dias_vida_util')->label('Días de vida útil')->numeric()->minValue(1)->required(),
            ])->columns(2),
        ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('dias_vida_util')->label('Días de vida útil')->numeric()->alignEnd()->sortable(),
            ])
    ...
    {
        return ['index' => Pages\ListProductoVidaUtils::route('/')];
    }
}
