...
use App\Filament\Resources\CantidadEstandarArranqueResource\Pages;
use App\Models\CantidadEstandarArranque;
...
/** Cantidad de arranque estándar por producto (Directiva de Transferencia, Fase 0) -- vía "estándar" para local o producto nuevo sin historial. */
class CantidadEstandarArranqueResource extends Resource
{
    protected static ?string $model = CantidadEstandarArranque::class;
    protected static string|\BackedEnum|null $navigationIcon = 'heroicon-o-rocket-launch';
    protected static ?string $navigationLabel = 'Cantidad de arranque';
    protected static ?string $modelLabel = 'Cantidad de arranque';
    protected static ?string $pluralModelLabel = 'Cantidad de arranque';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->schema([
            Section::make()->schema([
                ...
                TextInput::make('cantidad_arranque')->label('Cantidad de arranque')->numeric()->minValue(0)->required(),
            ])->columns(2),
        ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('cantidad_arranque')->label('Cantidad de arranque')->numeric()->alignEnd()->sortable(),
            ])
    ...
    {
        return ['index' => Pages\ListCantidadEstandarArranques::route('/')];
    }
}
