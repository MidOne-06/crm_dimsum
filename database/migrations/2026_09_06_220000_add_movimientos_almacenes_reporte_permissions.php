...
return new class extends Migration
{
    private array $permissions = [
        ['name' => 'Ver reporte de movimientos entre almacenes', 'slug' => 'movimientos-almacenes.reporte.view', 'module' => 'Movimientos entre almacenes'],
        ['name' => 'Exportar reporte de movimientos entre almacenes', 'slug' => 'movimientos-almacenes.reporte.exportar', 'module' => 'Movimientos entre almacenes'],
    ];
