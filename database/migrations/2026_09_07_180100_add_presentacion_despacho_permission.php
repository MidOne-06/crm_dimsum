...
return new class extends Migration
{
    ...
    {
        $permission = ['name' => 'Gestionar presentaciones de despacho', 'slug' => 'presentacion-despacho.manage', 'module' => 'Stock Inicial', 'is_system' => true, 'created_at' => now(), 'updated_at' => now()];
    ...
    {
        $id = DB::table('permissions')->where('slug', 'presentacion-despacho.manage')->value('id');
        if ($id) DB::table('permission_role')->where('permission_id', $id)->delete();
        DB::table('permissions')->where('slug', 'presentacion-despacho.manage')->delete();
    }
};
