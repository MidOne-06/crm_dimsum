...
return new class extends Migration
{
    private array $permissions = [
        ['name' => 'Ver cuotas mensuales Restaurant', 'slug' => 'ventas.cuotas.view', 'module' => 'Ventas'],
        ['name' => 'Editar cuotas mensuales Restaurant', 'slug' => 'ventas.cuotas.edit', 'module' => 'Ventas'],
    ];
