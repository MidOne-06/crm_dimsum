...
return new class extends Migration
{
    private array $permissions = [
        ['name' => 'Ver costos y recetas comerciales', 'slug' => 'ventas.costos.view', 'module' => 'Ventas'],
        ['name' => 'Editar costos y recetas comerciales', 'slug' => 'ventas.costos.edit', 'module' => 'Ventas'],
    ];
