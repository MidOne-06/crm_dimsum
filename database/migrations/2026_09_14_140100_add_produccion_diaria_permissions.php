...
return new class extends Migration
{
    private array $permissions = [
        ['name' => 'Ver registro de producción', 'slug' => 'produccion-diaria.view', 'module' => 'Producción'],
        ['name' => 'Registrar producción diaria', 'slug' => 'produccion-diaria.registrar', 'module' => 'Producción'],
        ['name' => 'Aprobar producción diaria', 'slug' => 'produccion-diaria.aprobar', 'module' => 'Producción'],
    ];
